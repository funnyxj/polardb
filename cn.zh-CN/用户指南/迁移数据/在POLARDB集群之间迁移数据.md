...
2.  单击集群ID，进入详细信息页面。
3.  在访问信息区域，单击白名单列表后面的![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17772/15347339619775_zh-CN.png)图标，在弹出的对话框中添加DTS的IP段。
...
迁移前，您需要为源POLARDB集群和目的POLARDB集群创建数据库账号。您可以创建初始账号，具体操作请参考[创建集群初始账号](cn.zh-CN/快速入门/创建集群初始账号.md)。
...
4.  填写源集群的信息。
    ...
    -   数据库类型：选择 **MySQL**。
    -   主机名或IP地址：输入POLARDB集群的公网连接串。您可以参考[查看连接地址](cn.zh-CN/快速入门/连接集群或实例/查看连接地址.md)。
    -   端口：输入3306
    -   数据库账号：POLARDB数据库实例的账号。
    -   数据库密码：以上账号的密码。
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17772/15347339619778_zh-CN.png)
...
12. 单击目标地域，查看迁移状态。迁移完成时，状态为**已完成**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17772/15347339619779_zh-CN.png)
