...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3008/15331039952077_zh-CN.png)
...
读写分离数据库接入功能，是POLARDB集群默认免费提供的一个透明、高可用、自适应的负载均衡能力。通过读写分离地址，SQL请求自动转发到POLARDB集群的各个实例，提供聚合、高吞吐的并发SQL处理能力。具体请参见[读写分离](../../../../cn.zh-CN/用户指南/读写分离.md)。
